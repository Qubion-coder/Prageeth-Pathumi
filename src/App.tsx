...
/**
 * Premium White & Blue Wedding Invitation Theme
 * Names: Prageeth & Pathumi
 * Background: White
 * Accents: Blue
 */
...
function CountdownTimer() {
  const targetDate = new Date("Oct 15, 2026 09:30:00").getTime();
...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxgso8aMtz8sj13Q_JsAA7od-efWt0GPKofEndGlIYYlGv6jxSI5hDE4zBUGHqehcCRaQ/exec";
      ...
      <AnimatePresence mode="wait">
        {!isOpened ? (
          <motion.div
            ...
            className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-theme-50 overflow-hidden"
          >
            {/* Background Image behind everything */}
            <div 
              className="absolute inset-0 bg-cover bg-center" 
              style={{ backgroundImage: "url('/ChatGPT Image Sep 18, 2026, 11_06_13 PM.png')" }} 
            />
            ...
            >
              <div className="absolute -inset-4 bg-gradient-to-r from-violet-200 via-amber-100 to-sky-200 blur-2xl opacity-40 animate-pulse" />
              <motion.button
                whileHover={{ scale: 1.05, backgroundColor: "rgba(255, 255, 255, 1)" }}
                whileTap={{ scale: 0.95 }}
                onClick={openInvitation}
                className="group relative flex flex-col items-center gap-4 bg-white/95 backdrop-blur-md border border-white/60 px-14 py-6 rounded-full text-stone-800 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.12)] transition-all duration-500 hover:shadow-violet-200/30"
              >
                ...
                <div className="w-10 h-[1.5px] bg-gradient-to-r from-violet-300 via-amber-300 to-sky-300 group-hover:w-20 transition-all duration-500" />
            ...
            <div className="absolute top-12 left-1/2 -translate-x-1/2 z-10 pointer-events-none">
              <p className="font-cinzel text-[11px] tracking-[0.8em] font-bold uppercase flex flex-col items-center gap-3">
                <span className="bg-gradient-to-r from-violet-400 via-amber-400 to-sky-400 bg-clip-text text-transparent opacity-80">P & P</span>
          ...
          >
              ...
              <div className="max-w-[1000px] w-full flex flex-col items-center text-center relative z-10">
                ...
                >
                  ...
                  <div className="text-zinc-800 text-center max-w-2xl px-6">
                    ...
                    {hasGuest ? (
                      <p className="font-serif text-[15px] md:text-xl leading-[1.8] md:leading-loose text-zinc-700 font-light uppercase px-2">
                        REQUEST THE HONOUR OF THE PRESENCE OF
                        <span className="block text-[24px] md:text-3xl font-playball text-theme-700 my-4 capitalize tracking-wide drop-shadow-sm">
                          {guestPrefix.toLowerCase() === 'dear' ? guestName : `${guestPrefix} ${guestName}`}
                        </span>
                        <span className="text-theme-700 font-medium block mt-2 md:mt-0 md:inline"> TO CELEBRATE OUR MARRIAGE</span>
                      </p>
                    ) : (
                      <p className="font-serif text-[15px] md:text-xl leading-[1.8] md:leading-loose text-zinc-700 font-light uppercase px-2">
                        REQUEST THE HONOUR OF THE PRESENCE OF<br />MISS / MR / MRS / MR & MRS / FAMILY
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-[13px] md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr & Mrs Gunathilake</p>
                      </div>
                      <h3 className="text-[49px] md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Prageeth</h3>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="relative z-10 space-y-4 py-8 md:py-12">
                      <div className="space-y-2">
                        ...
                        <p className="text-[13px] md:text-sm font-cinzel text-stone-600 tracking-wide leading-relaxed">Mr & Mrs Weerasooriya</p>
                      </div>
                      <h3 className="text-[49px] md:text-7xl font-playball text-theme-800 group-hover:scale-110 transition-transform duration-700 pt-6 drop-shadow-sm">Pathumi</h3>
                    </div>
                  </motion.div>
                </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-32 text-center w-full max-w-4xl px-4">
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-[21px] md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">2026.10.15</p>
                      <p className="font-cinzel text-[16px] md:text-lg text-theme-600 tracking-[0.3em] font-normal mt-2">THURSDAY 15TH OCTOBER</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center flex-1">
                      ...
                      <p className="font-cinzel text-[21px] md:text-3xl text-theme-900 tracking-widest font-bold whitespace-nowrap">09:30 AM</p>
                      <p className="font-cinzel text-[13px] md:text-sm text-theme-600 tracking-[0.2em] mt-3 uppercase">To 4:30 PM</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="space-y-4 flex flex-col items-center">
                      ...
                      <div className="flex items-center gap-6 mt-6">
                        ...
                        <div className="flex flex-col items-center">
                          <p className="font-cinzel text-[21px] md:text-2xl text-theme-700 font-bold tracking-[0.2em]">10:00 AM</p>
              ...
              <div className="w-full max-w-[1000px] px-4 flex flex-col items-center text-center relative z-10">
                ...
                >
                  ...
                  <h2 className="font-cinzel text-[31px] md:text-5xl text-theme-900 mb-8 relative z-10 tracking-widest font-bold drop-shadow-sm px-4 leading-[1.4]">
                    Forever <span className="font-playball text-theme-700 italic lowercase tracking-normal text-[37px] md:text-7xl ml-2">begins</span>
                  </h2>
                ...
                <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
                  ...
                  >
                    <div className="flex flex-col items-start gap-4">
                      ...
                      <h2 className="font-playball text-[3.5rem] sm:text-[4rem] md:text-[4.5rem] text-theme-900 leading-[1.1] drop-shadow-sm ml-[-4px]">
                        Sannasa Grand
                      </h2>
                    </div>
                    ...
                    <div className="pt-8 w-full md:w-auto">
                      <button
                        onClick={() => window.open('https://maps.app.goo.gl/XfFGwo4BmeKTayEn9', '_blank')}
            ...
            <section className="cv-auto py-24 md:py-36 bg-[#18181B] text-white relative overflow-hidden flex flex-col items-center">
              ...
              <div className="container mx-auto px-4 max-w-2xl text-center relative z-10 w-full">
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 mb-12 text-white font-cinzel tracking-wider bg-white/10 py-4 px-8 rounded-full shadow-[0_0_15px_rgba(255,255,255,0.05)] border border-white/20 mx-4 md:mx-auto max-w-fit">
                    <div className="flex items-center gap-3">
                      <span className="font-bold text-theme-200 uppercase text-[10px] md:text-xs tracking-[0.2em]">Prageeth</span>
                      <span className="text-sm md:text-base">0712998490</span>
                    </div>
                    <div className="hidden md:block w-1.5 h-1.5 rounded-full bg-theme-300"></div>
                    <div className="flex items-center gap-3">
                      <span className="font-bold text-theme-200 uppercase text-[10px] md:text-xs tracking-[0.2em]">Pathumi</span>
                      <span className="text-sm md:text-base">0764514822</span>
                    </div>
                  </div>
            ...
            <div className="relative bg-[#FFFFFF]">
              ...
              <section className="cv-auto py-24 md:py-36 relative flex flex-col items-center overflow-hidden">
                <InviteImage src={flowerImage} alt="" className="absolute top-0 right-0 w-[40vw] max-w-[500px] opacity-100 translate-x-1/3 -translate-y-1/3 pointer-events-none" />
                <InviteImage src={flowerImage} alt="" className="absolute bottom-16 left-1/2 w-[38vw] max-w-[360px] opacity-100 -translate-x-1/2 pointer-events-none" />
                ...
                <div className="container mx-auto px-4 max-w-4xl text-center relative z-10 w-full">
                  ...
                  >
                    ...
                    <p className="text-stone-500 text-[15px] md:text-lg leading-relaxed max-w-xl mx-auto mb-16 font-light tracking-wide px-4">
                      ...
                      <form className="space-y-8 text-left relative z-10" onSubmit={(e) => { e.preventDefault(); handleSubmit("wish", wishData); }}>
                        <div className="space-y-3">
                          ...
                          <input
                            ...
                            className="w-full bg-stone-50/50 border-b border-theme-200 px-4 py-4 text-theme-900 placeholder:text-stone-300 focus:outline-none focus:border-theme-400 focus:bg-white transition-all font-cinzel text-[19px] tracking-wide rounded-t-lg"
                          />
                        </div>
                        <div className="space-y-3">
                          ...
                          <textarea
                            ...
                            className="w-full bg-stone-50/50 border-b border-theme-200 px-4 py-4 text-theme-900 placeholder:text-stone-300 focus:outline-none focus:border-theme-400 focus:bg-white transition-all font-cinzel text-[19px] tracking-wide resize-none rounded-t-lg"
                          />
                        </div>
                    ...
                    <div className="mt-32 md:mt-48 space-y-6 flex flex-col items-center relative w-full">
                      ...
                      <h3 className="font-playball text-[3.2rem] sm:text-6xl md:text-7xl text-theme-900 relative z-10 drop-shadow-sm px-4 pt-4 leading-none">Prageeth & Pathumi</h3>
              ...
              <footer className="py-20 border-t border-theme-200/30 text-center relative z-10 space-y-6">
                ...
                <p className="text-[9px] md:text-[11px] uppercase tracking-[0.5em] text-stone-500 font-bold">
                  © 2026 Prageeth & Pathumi. All rights reserved.
                </p>
